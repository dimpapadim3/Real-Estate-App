...
angular.module('starter', ['ionic', 'starter.controllers', 'starter.services', 'daypilot', 'underscore'])
...
.config(function ($stateProvider, $urlRouterProvider) {
    ...
    .state('tab.account', {
      ...
      .state('tab.newproperty', {
        url: '/newproperty',
        views: {
            'tab-newproperty': {
                templateUrl: 'templates/new-property.html',
...
app.constant('config', {
    gateWayAddress: "http://www.mesitikogateway.somee.com",
